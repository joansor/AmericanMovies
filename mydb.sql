...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 23 fév. 2020 à 02:40
...
CREATE TABLE IF NOT EXISTS `artistes` (
  ...
  `biographie_a` longtext DEFAULT NULL,
  `date_de_naissance_a` date NOT NULL,
  `note_a` double NOT NULL DEFAULT 0,
  PRIMARY KEY (`id_a`)
...
CREATE TABLE IF NOT EXISTS `commentaires` (
  ...
  `idd` int(11) NOT NULL,
  `commentaire_c` longtext NOT NULL,
...
CREATE TABLE IF NOT EXISTS `films` (
  ...
  `duree_f` varchar(255) NOT NULL,
  `note_f` double NOT NULL DEFAULT 0,
...
INSERT INTO `films` (`id_f`, `titre_f`, `poster_f`, `annee_f`, `resume_f`, `duree_f`, `note_f`, `video_f`) VALUES
(18, 'Les Affranchis', 'les-affranchis.jpg', 1990, 'Dans les années 1950, à Brooklyn, le jeune Henry Hill a l\'occasion de réaliser son rêve : devenir gangster lorsqu\'un caïd local l\'intègre à son équipe. C\'est alors qu\'il rencontre James et Tommy, 2 truands d\'une rare brutalité. Impressionné, Henry s\'associe avec eux pour débuter un trafic très lucratif. Lorsqu\'il séduit la ravissante Karen, le jeune mafieux s\'imagine que plus rien ni personne ne pourra jamais lui résister.', '2h28m', 7, 'https://www.dailymotion.com/embed/video/x4ouyhw'),
(19, 'Seven', 'seven.jpg', 1996, 'Peu avant sa retraite, l\'inspecteur William Somerset, un flic désabusé, est chargé de faire équipe avec un jeune idéaliste, David Mills. Ils enquêtent tout d\'abord sur le meurtre d\'un homme obèse que son assassin a obligé à manger jusqu\'à ce que mort s\'ensuive. L\'enquête vient à peine de commencer qu\'un deuxième crime, tout aussi macabre, est commis, puis un troisième. Petit à petit, les deux policiers font le lien entre tous ces assassinats.', '2h08m', 0, 'https://www.dailymotion.com/embed/video/x193cm'),
(20, 'Il Etait Une Fois Dans L\'ouest', 'il-etait-une-fois-dans-l-ouest.jpg', 1969, 'Alors qu\'il prépare une fête pour sa femme, Bet McBain est tué avec ses trois enfants. Jill McBain hérite alors les terres de son mari, terres que convoite Morton, le commanditaire du crime (celles-ci ont de la valeur maintenant que le chemin de fer doit y passer). Les soupçons se portent sur un aventurier, Cheyenne.', '2h55m', 0, 'https://www.dailymotion.com/embed/video/x2ksbdl'),
...
--
-- Structure de la table `votes_commentaires`
--

DROP TABLE IF EXISTS `votes_commentaires`;
CREATE TABLE IF NOT EXISTS `votes_commentaires` (
...
--
-- Déchargement des données de la table `votes_commentaires`
--

INSERT INTO `votes_commentaires` (`id_vote`, `id_commentaire`, `id_utilisateur`, `vote`) VALUES
(3, 21, 1, 1),
(4, 20, 1, 1),
(5, 19, 1, 1),
(6, 1, 1, 1),
...
--
-- Structure de la table `_commentaires`
--

DROP TABLE IF EXISTS `_commentaires`;
CREATE TABLE IF NOT EXISTS `_commentaires` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `module` varchar(20) NOT NULL,
  `idd` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `_commentaires`
--

INSERT INTO `_commentaires` (`id`, `module`, `idd`, `commentaire_c`, `Utilisateurs_id_u`, `note`) VALUES
(14, 'Films', 18, 'voici mon commentaire valeur de 6', 1, 6),
(15, 'Films', 18, 'voici mon commentaire de valeur 10', 1, 10),
(16, 'Films', 18, 'voici le commentaire note de 3', 1, 3),
(17, 'Films', 18, 'voici le commentaire note de 3', 1, 3),
(18, 'Films', 18, 'tttttttt', 1, 9),
(19, 'Films', 18, 'tttttttt', 1, 9),
(20, 'Films', 18, 'tttttttt', 1, 9),
(21, 'Films', 18, 'tttttttt', 1, 9),
(22, 'Films', 43, 'jjj', 1, 9),
(23, 'Films', 43, 'excellent', 1, 10),
(25, 'Films', 43, 'top', 1, 9),
(26, 'Films', 43, 'test', 1, 9),
(28, 'Films', 43, 'bof', 1, 3),
(29, 'Films', 43, 'bof', 1, 3),
(30, 'Films', 43, 'bof', 1, 3),
(31, 'Films', 43, 'bof', 1, 3),
...
(34, 'Films', 43, 'bof', 1, 3),
(35, 'Films', 43, 'bof', 1, 3),
(36, 'Films', 43, 'bbooff', 1, 5),
(37, 'Films', 43, 'bbooff', 1, 5),
(38, 'Films', 43, 'bbooff', 1, 5),
(39, 'Films', 43, 'bbooff', 1, 5),
(40, 'Films', 43, 'bbooff', 1, 5),
(41, 'Films', 43, 'bbooff', 1, 5),
(42, 'Films', 43, 'bbooff', 1, 5),
(43, 'Films', 43, 'bbooff', 1, 5),
(44, 'Films', 43, 'bbooff', 1, 5),
(45, 'Films', 43, 'bbooff', 1, 5),
(46, 'Films', 43, 'yy', 1, 10),
(47, 'Films', 43, 'test', 1, 10),
(48, 'Films', 43, 'test', 1, 10),
(49, 'Films', 43, 'test', 1, 10),
(50, 'Films', 43, 'test', 1, 10),
(51, 'Films', 43, 'retest', 1, 7),
(52, 'Films', 43, 'yo', 1, 9),
(53, 'Films', 43, 'yoyo', 1, 10);
...
--
-- Contraintes pour la table `_commentaires`
--
ALTER TABLE `_commentaires`
  ADD CONSTRAINT `fk_Commentaires_Utilisateurs1` FOREIGN KEY (`Utilisateurs_id_u`) REFERENCES `utilisateurs` (`id_u`),
  ADD CONSTRAINT `fk_commentaires_Films1` FOREIGN KEY (`idd`) REFERENCES `films` (`id_f`);
COMMIT;
