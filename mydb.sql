...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 25 fév. 2020 à 05:04
...
INSERT INTO `comments` (`id`, `module`, `idd`, `commentaire_c`, `Utilisateurs_id_u`, `note`) VALUES
(5, 'Films', 43, 'test', 1, 3),
(16, 'Films', 43, 'top', 1, 5),
(7, 'Artistes', 16, 'TOP', 1, 7),
(8, 'Films', 30, 'top', 1, 9),
(9, 'Films', 43, 're', 1, 9),
(10, 'Films', 43, 'TEST', 1, 9),
(18, 'Artistes', 16, 'ok', 1, 6),
(19, 'Artistes', 15, 'yo', 1, 8),
(20, 'Artistes', 15, 'ooop', 1, 10),
(21, 'Artistes', 15, 'ok', 1, 9),
(25, 'Artistes', 15, 'top', 1, 9);

-- --------------------------------------------------------

--
-- Structure de la table `commentsvotes`
--
...
--
-- Déchargement des données de la table `commentsvotes`
--

INSERT INTO `commentsvotes` (`id_vote`, `id_commentaire`, `id_utilisateur`, `vote`) VALUES
(3, 21, 1, 1),
(4, 20, 1, 1),
(5, 19, 1, 1),
(6, 1, 1, 1),
...
INSERT INTO `genres` (`id_g`, `genre_du_film`) VALUES
(3, 'Action'),
(4, 'Adventure'),
(13, 'Animation'),
(5, 'Comedy'),
...
INSERT INTO `users` (`id_u`, `type_user`, `username`, `password`, `email`, `create_time`) VALUES
...
ALTER TABLE `appartient`
  ...
  ADD CONSTRAINT `fk_Appartient_Genre1` FOREIGN KEY (`Genre_id_g`) REFERENCES `genres` (`id_g`);
