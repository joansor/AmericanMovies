...
--
-- Structure de la table `commentaires_votes`
--

DROP TABLE IF EXISTS `commentaires_votes`;
CREATE TABLE IF NOT EXISTS `commentaires_votes` (
...
INSERT INTO `commentaires_votes` (`id_vote`, `id_commentaire`, `id_utilisateur`, `vote`) VALUES
(3, 21, 1, 1),
(4, 20, 1, 1),
(5, 19, 1, 1),
(6, 1, 1, 1),
