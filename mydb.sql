...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  ven. 21 fév. 2020 à 07:39
...
CREATE TABLE IF NOT EXISTS `artistes` (
  ...
  `note_a` varchar(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_a`)
...
CREATE TABLE IF NOT EXISTS `commentaires` (
  ...
  KEY `Artistes_id_a` (`Artistes_id_a`)
...
INSERT INTO `commentaires` (`id`, `Films_id_f`, `Artistes_id_a`, `commentaire_c`, `Utilisateurs_id_u`, `note`) VALUES
(14, 18, 0, 'voici mon commentaire valeur de 6', 1, 6),
(15, 18, 0, 'voici mon commentaire de valeur 10', 1, 10),
(16, 18, 0, 'voici le commentaire note de 3', 1, 3),
(17, 18, 0, 'voici le commentaire note de 3', 1, 3),
(18, 18, 0, 'tttttttt', 1, 9),
(19, 18, 0, 'tttttttt', 1, 9),
(20, 18, 0, 'tttttttt', 1, 9),
(21, 18, 0, 'tttttttt', 1, 9);
...
CREATE TABLE IF NOT EXISTS `films` (
  ...
  `duree_f` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `note_f` int(11) NOT NULL DEFAULT '0',
